...
CombatCounter(0)
!See([ENEMY])
Global("X3milyDorn1","GLOBAL",0)~ THEN BDORN X3milyDorn1
@3 // ~Why are you here?~
DO ~SetGlobal("X3milyDorn1","GLOBAL",1)~
== X3milyB @4 // ~Who, me?~
== BDORN @5 // ~You whine at every encounter and bemoan every sight of blood. The battlefield is not for you.~
== X3milyB @6 // ~If I have to fight, I have to fight. I just wish it wasn't necessary.~
== BDORN @7 // ~It's not necessary for you to be here and complain about killing. If it isn't them, it's us.~
== X3milyB @8 // ~There is another way, sometimes. Possibly.~
== BDORN @9 // ~So weak. Get out of my way.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3milyNeera1","GLOBAL",0)~ THEN BNEERA X3milyNeera1
...
== BNEERA @12 // ~And that's just how I like it.~
...
== BRASAAD @16 // ~I thank you for your compliment, Emily. It is work of years of rigorous exercise and training.~
== X3milyB @17 // ~It really is. Very, very, something. I wouldn't mind observing you at work.~
== BRASAAD @18 // ~Should time allow it, I would be pleased to assist.~
...
== BNEERA @21 // ~That's...a rather personal question, Emily.~ 
...
== BNEERA @24 // ~Yeah...it's the past, isn't it?~
...
== BNEERA @27 // ~I know, I know, but...I'm fine. Really.~
EXIT 
...
== BRASAAD @29 // ~You are quite flexible, Emily. You would be a good student of the path.~
...
== BRASAAD @32 // ~At your leisure, my friend.~
EXIT 
...
DO ~SetGlobal("X3milyRasaad1","GLOBAL",2)~
== BRASAAD @34 // ~I do not. But you speak of this revelation as if it makes you worse. Why is this?~
== X3milyB @35 // ~I don't want people to look at me any different. I just want to  be Emily.~
== BRASAAD @36 // ~Then be Emily. You wear your concern on your skin, so it is seen. Before, no one knew because you were you, and you were not defined for it.~
== BRASAAD @37 // ~Be who you always have been, who you are. You are good and kind, and that shall remain so as long as you allow it.~
